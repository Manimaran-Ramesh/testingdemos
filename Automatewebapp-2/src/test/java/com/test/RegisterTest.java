...
public class RegisterTest {
	WebDriver chrome;
	  ...
	  public void register() {
		  ...
		  email.sendKeys("shakishakk@gmail.com");
	  ...
	  public void login()
	  {
			  ...
			  email.sendKeys("shakishak@gmail.com");
			  
			  WebElement password= chrome.findElement(By.id("passwd"));
			  password.sendKeys("Maran707");
